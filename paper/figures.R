...
sentences <- fread('pgmine_sentences.tsv',sep='\t',header=T,stringsAsFactors=T,quote='', encoding = 'UTF-8')
collated <- fread('pgmine_collated.tsv',sep='\t',header=T,stringsAsFactors=T,quote='', encoding = 'UTF-8')
